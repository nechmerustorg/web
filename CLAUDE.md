...
| `GET /api/ukoly` | Nesplnné úkoly |
| `GET /api/kalendar` | Nadázející události |
...
- **Demo data**: Seed data mají `gmail_id = NULL` / `google_id = NULL`. Sync routes je maží po úspěšné synchronizaci reálných dat.
